...
import 'dart:math';
import 'package:flutter_frontend/graphql/speaking/speaking.queries.graphql.dart';
import '../screens/speaking_history_screen.dart';
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => Navigator.push(
              context,
              MaterialPageRoute(builder: (_) => const HistorySpeakingScreen()),
            ),
          ),
        ],
      ),
          ...
          child: Query(
            ...
            builder: (result, {refetch, fetchMore}) {
              ...
              final parsedData = result.data != null
                  ...
                  : null;
              final tests = parsedData?.getSpeakingTests ?? [];
              ...
              if (tests.isNotEmpty) {
                for (var key in averageScores.keys) {
                  ...
                  for (var test in tests) {
                    final scoreJson = test.scores.toJson();
                    final val = scoreJson[key];
