...
class Fragment_SpeakingMistakeFields {
  Fragment_SpeakingMistakeFields({
    required this.error,
    required this.correction,
    required this.type,
    this.$__typename = 'SpeakingMistake',
  });

  factory Fragment_SpeakingMistakeFields.fromJson(Map<String, dynamic> json) {
    final l$error = json['error'];
    final l$correction = json['correction'];
    final l$type = json['type'];
    final l$$__typename = json['__typename'];
    return Fragment_SpeakingMistakeFields(
...
abstract class CopyWith_Fragment_SpeakingMistakeFields<TRes> {
  factory CopyWith_Fragment_SpeakingMistakeFields(
    Fragment_SpeakingMistakeFields instance,
    TRes Function(Fragment_SpeakingMistakeFields) then,
  ) = _CopyWithImpl_Fragment_SpeakingMistakeFields;

  factory CopyWith_Fragment_SpeakingMistakeFields.stub(TRes res) =
      _CopyWithStubImpl_Fragment_SpeakingMistakeFields;
...
class _CopyWithImpl_Fragment_SpeakingMistakeFields<TRes>
  ...
  final TRes Function(Fragment_SpeakingMistakeFields) _then;
