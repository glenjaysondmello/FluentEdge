...
import 'package:mobile/features/speaking/presentation/screens/speaking_test_screen.dart';
  ...
  Future<void> _startNewTest(BuildContext context) async {
    ...
    try {
      final result = await client.query(
        QueryOptions(
          document: documentNodeQueryGetSpeakingTestText,
      ...
      final parsedData = result.data != null
          ? Query_GetSpeakingTestText.fromJson(result.data!)
          : null;

      final String? referenceText = parsedData?.getSpeakingTestText;
